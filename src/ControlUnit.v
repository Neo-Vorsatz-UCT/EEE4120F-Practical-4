...
module ControlUnit (
    ...
    always @(*) begin
        // First, assign safe defaults to ALL outputs at the top of the
        ...
        // Handle each opcode with nondefault signals.
        ...
        case (opcode)
            ...
            4'b0010, 4'b0011, 4'b0100, 4'b0101, // ADD, SUB, INV, SHL
            4'b0110, 4'b0111, 4'b1000, 4'b1001: // SHR, AND,  OR, SLT
            begin
                reg_dst = 1'b1;
                reg_write = 1'b1;
                alu_op = 2'b0;
